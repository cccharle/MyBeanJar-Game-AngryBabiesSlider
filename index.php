                        ...
                        <div id="intro02" class="intro">
                            <div class="title-bits"> 
                                ...
                                <div class="start-cbldf">
                                    <img class="title-element start-cbldf-logo" src="img/cbldf-logo.png">
                                    <p class="start-cbldf-descrip">Comic Book Legal Defense Fund is a non-profit organization dedicated to protecting the First Amendment rights of the comics medium.</p>
                                </div>
                                <div class="title-element button-pool start-buttons">
                                    <button class="btn-ab btn-ab-r" onclick="javascript:loadGame()">Play</button>
                                    <input class="btn-ab btn-ab-l" type="button" value="About CBLDF" onclick="GoToCBLDF()" />
                                </div>
                            </div>
                        </div>
                    <!-- </div> -->
