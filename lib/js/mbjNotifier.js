...
jQuery(document).ready(function(){
	jQuery(".mbj-footer").click(function(){
		console.log("clickbang!");
		if (!footerCollapsed){
			jQuery("#main_container").animate({opacity: 0}, 200, function(){
				jQuery("#main_container").animate({height: "0vh"}, 800, function(){
					footerCollapsed = true;
				});
			});
		}
		else {
			jQuery("#main_container").animate({height: "11vh"}, 800, function(){
