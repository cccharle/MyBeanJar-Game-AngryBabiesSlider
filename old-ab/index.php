     ...
     <?php
        ...
        var imagepath = "'img/puzz/<?php echo $images[$i] ?>'";
           ...
           // imagepath = imagepath+imagename;
            strhtml = strhtml+'<li><div><img src="img/puzz/<?php echo $images[$i] ?>" '+clickhere+' ><span>TITLE ARTIST</span>'+
                    ...
                    <div id="intro02" class="intro">
                        <div class="title-bits"> 
                            ...
                            <div class="start-cbldf">
                                ...
                                <img class="title-element sm-logo" src="img/mbj-logo.png">
                            </div>
                ...
                <div data-role="content" class="content ">
                    <div  class="intro scrool">
                        <div class="listing-page-custom">
                            <div class="des-info">
                                <!--<button class="btn-ab" onclick="javascript:gotohome()">Home</button>-->
                                <p>ANGRY BABIES NEED TO PLAY!</p>
                                <p class="small-text">EACH PURCHASE INCLUDES 
...
A FREE COLLECTOR POSTER</p><p>99¢ EACH- TAKE EM ALL</p>
        ...
        for ($i = 0; $i < count($images); $i++) {
            ...
            <li><div>
                    <img src="img/puzz/<?php echo $images[$i] ?>" onclick="javascript:getimage('img/puzz/<?php echo $images[$i] ?>')"><span>TITLE ARTIST</span>
                    <input id="radio1[]" type="checkbox" name="radio[]" value="<?php echo $images[$i] ?>"  >
                <label for=""><span><span></span></span></label></div></li>
        <?php } ?>      
                ...
                <div class="mbj_notification_pane mbj_login_or_register inactive_pane" id="mbj_register">
                    <form class="formoid-default-skyblue" id="mbj_registration_form" method="post">
                        ...
                        <div class="element-input">
                            ...
                            <input class="mbj_checkbox" typckbox" value="Charitable Donation"><span class="form-checkbox">Charitable Domation</span>
